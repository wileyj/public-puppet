class bastion::params{
    ...
    $keys                = hiera('bastion::keys', {})
    $sudo                = hiera('bastion::sudo::conf', {})
    $cron                = hiera('bastion::cron::job', {})
    $sysctl              = hiera('bastion::sysctl',{})
    $services            = hiera('bastion::services',[])
    $packages            = hiera('bastion::packages',[])
    $ssh_packages        = hiera('bastion::ssh::packages',[])
