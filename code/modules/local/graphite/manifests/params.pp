class graphite::params{
    ...
    $sudo                                         = hiera('graphite::sudo::conf', {})
    $cron                                         = hiera('graphite::cron::job', {})
    $sysctl                                       = hiera('graphite::sysctl', {})
    ...
    # carbon::cache:a
    # $carbon_a_line_receiver_port                = hiera('graphite::a_line_receiver_port')
    # $carbon_a_pickle_receiver_port              = hiera('graphite::a_pickle_receiver_port')
    # $carbon_a_cache_query_port                  = hiera('graphite::a_cache_query_port')
    # carbon::cache:b
    # $carbon_a_line_receiver_port                = hiera('graphite::b_line_receiver_port')
    # $carbon_a_pickle_receiver_port              = hiera('graphite::b_pickle_receiver_port')
    # $carbon_a_cache_query_port                  = hiera('graphite::b_cache_query_port')
    # 
